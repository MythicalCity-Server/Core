...
public abstract class RarityArmor extends CustomArmor {
	...
	public RarityArmor(Material material, String name, String description, Rarity rarity) {
		super();
	...
	public RarityArmor(Material material, String name, String description, Rarity rarity, int startingDurability) {
		super();
		this._MATERIAL = material;
		this._NAME = name;
		this._PRE_DESC = description;
