...
public class ItemFactory {
    ...
    public static void setEquipmentSlot(LivingEntity entity, EquipmentSlot slot, ItemStack i) {
        switch (slot) {
            case CHEST:
                entity.getEquipment().setChestplate(i);
                break;
            case FEET:
                entity.getEquipment().setBoots(i);
                break;
            case HAND:
                entity.getEquipment().setItemInMainHand(i);
                break;
            case HEAD:
                entity.getEquipment().setHelmet(i);
                break;
            case LEGS:
                entity.getEquipment().setLeggings(i);
                break;
            case OFF_HAND:
                entity.getEquipment().setItemInOffHand(i);
                break;
            default:
                break;
        }
